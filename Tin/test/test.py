...
from gradio.themes.utils import colors, fonts, sizes # type: ignore
...
from private_gpt.ui.images import logo_fpt

logger = logging.getLogger(__name__)

THIS_DIRECTORY_RELATIVE = Path(__file__).parent.relative_to(PROJECT_ROOT_PATH)
# Should be "private_gpt/ui/avatar-bot.ico"
AVATAR_BOT = THIS_DIRECTORY_RELATIVE / "fpt.png"

UI_TAB_TITLE = "FPT Digital AI Assistant"
...
class PrivateGptUi:
    ...
    def _build_ui_blocks(self) -> gr.Blocks:
        ...
        with gr.Blocks(
            ...
            "align-items: center;"
            "}"
            ".logo img {max-height: 15vh; width: 100%; height: auto; object-fit: cover;  }"
            ...
            with gr.Row():
                gr.HTML(f"<div class='logo'/><img src={logo_fpt} alt=FPT Digital AI Assistant></div")
